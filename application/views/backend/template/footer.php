        ...
        <script type="text/javascript">
            $(function(){
                ...
                if ($('#edit-berita').length > 0) {
                    ...
                    function(data){
                        ...
                        $('#readmore').summernote("code",data.readmore);
                        $('#isi').summernote("code",data.isi);
                        $('#tags').val(data.tags).change();
                        $('#status').val(data.status).change();

                        $('#loadering').addClass('d-none');
            ...
            function edit_galeri(id){
                $.post("<?=base_url('admin/galeri/edit/')?>",
                {
                  id:id
                },
                function(data){
            ...
            function edit_unduhan(id){
                $.post("<?=base_url('admin/download/edit/')?>",
                {
                  id:id
                },
                function(data){
            ...
            function edit_layanan(id){
                $.post("<?=base_url('admin/informasi/edit_layanan/')?>",
                {
                  id:id
                },
                function(data){
                  $('#modal-edit').modal('toggle');
                  $('#judul_layanan').val(data.judul_layanan);
                  $('#deskripsi_layanan').summernote("code",data.deskripsi_layanan);
                  $('#xid').val(data.id);
                });
            }
            ...
            function edit_struktur(id){
                $.post("<?=base_url('admin/profil/edit_struktur/')?>",
                {
                  id:id
                },
                function(data){
                  $('#modal-edit').modal('toggle');
                  $('#struktur').summernote("code",data.isi);
                  $('#xid').val(data.id);
                });
            }
