            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">
                        <i class="far fa-cloud-download"></i> Tambah Data LKPJ
                    </h4>
                ...
                <div class="modal-body">
                    ...
                    <form method="post" action="<?=base_url('admin/informasi/save_lkpj')?>" enctype='multipart/form-data'>
    ...
    <div class="modal fade" id="modal-edit" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">
                        <i class="far fa-edit"></i> Edit Data LKPJ
                    </h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true"><i class="fal fa-times"></i></span>
                    </button>
                ...
                <div class="modal-body">
                    <!-- <div class="js-summernote"></div> -->
                    <form method="post" action="<?=base_url('admin/informasi/update_lkpj')?>" enctype='multipart/form-data'>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        <i class="far fa-cloud-download"></i> Data <span class="fw-300"><i>Renja</i></span>
                    </h2>
                </div>
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <button data-toggle="modal" data-target="#modal-tambah" type="button" class="btn btn-info"><i class="far fa-plus-hexagon"></i> Tambah Data LKPJ</button>
                        <hr>
                        <!-- datatable start -->
                                ...
                                <?php $no=1; foreach ($data as $d): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:;" class="btn btn-danger btn-icon rounded-circle del" rel="<?=base_url('admin/informasi/hapus_lkpj/').$d['id']?>"><i class="far fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php $no++; endforeach ?>
                            </tbody>
